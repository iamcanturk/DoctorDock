...
subtitle: "Because for months I didn't really know what was running on my machine"
description: "I used Docker every day but had no idea what was inside it. DoctorDock scans your local Docker for security problems, misconfigurations, and reclaimable disk in under a second — entirely offline, no AI."
date: 2026-08-14
author: "Can Türk"
lang: en
tags: [docker, security, devops, open-source, cli]
...
![A DoctorDock health card: a Docker health score out of 100 with resource counts](https://doctordock.iamcanturk.dev/assets/health-card.png)
